// SoilSense Model Data - Malawi Version (Extended for Dynamic Inputs)
const MODEL = {
    feature_names: [
        "PH", "OC", "Mg", "N", "P", "K", "Zn", "Fe", "Cu", "Mn",
        "Sand", "Silt", "Clay", "CaCO3", "CEC", "Moisture_Content"
    ],
    ...
    // Optional additional nutrients/properties
    dynamic_features: [], // store user-added inputs
    addDynamicFeature: function(name, value, min=null, max=null){
        // basic validation & storage
        if(!name) return;
        this.dynamic_features.push({name, value, min, max});
    },
    clearDynamicFeatures: function(){
        this.dynamic_features = [];
    }
};
